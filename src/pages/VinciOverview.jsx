  ...
  return (
    <div>
      ...
      <div className="font-figtree bg-[#FFFFFF] min-h-screen">
        <OverviewHeader dataset= {vinciData} />
        <OverviewAbout dataset= {vinciData} />
        <ImpactfulBrands />
        <GlobalRating dataset= {vinciData} />
        <GlobalReviews dataset= {vinciData} />
        <SalarySlider />
      </div>
