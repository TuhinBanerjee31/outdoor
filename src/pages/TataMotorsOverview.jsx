...
const TataMotorsOverview = () => {
  return (
    <div>
      <Navbar />

      <div className="font-figtree bg-[#FFFFFF] min-h-screen">
        <OverviewHeader dataset= {tataMotorsData} />
        <OverviewAbout dataset= {tataMotorsData} />
        <ImpactfulBrands />
        <GlobalRating dataset= {tataMotorsData} />
        <GlobalReviews dataset= {tataMotorsData} />
        <SalarySlider />
      </div>
...
export default TataMotorsOverview