...
const IciciBankOverview = () => {
  return (
    <div>
      <Navbar />

      <div className="font-figtree bg-[#FFFFFF] min-h-screen">
        <OverviewHeader dataset= {iciciBankData} />
        <OverviewAbout dataset= {iciciBankData} />
        <ImpactfulBrands />
        <GlobalRating dataset= {iciciBankData} />
        <GlobalReviews dataset= {iciciBankData} />
        <SalarySlider />
      </div>
...
export default IciciBankOverview