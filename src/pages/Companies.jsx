...
import { allCompanyData } from "../Data/allCompanyData";
  ...
  return (
    <div className="font-figtree bg-[#FAFBFE]">
      ...
      <div className="min-h-screen py-10">
        ...
        <div className="max-w-screen-2xl flex flex-wrap gap-10 justify-around mx-auto bg-[#FFF5F0] py-16 px-10 rounded-xl">
