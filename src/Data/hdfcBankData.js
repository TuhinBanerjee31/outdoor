...
export const hdfcBankData = {
  ...
  about:
    "HDFC Bank is one of India’s leading private sector banks, offering a wide range of banking and financial services to retail and corporate customers. With a strong focus on customer-centric solutions, HDFC Bank is known for its innovation and use of technology in banking.",
  mission:
